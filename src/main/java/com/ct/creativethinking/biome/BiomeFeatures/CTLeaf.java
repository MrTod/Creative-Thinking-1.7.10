...
public class CTLeaf extends BlockLeaves {
    public static final String[][] leaftypes = new String[][]{{"LeafOreo"}, {"LeafOreoOpaque"}};
    public static final String[] leaves = new String[]{"Oreo"};
    ...
    //@Override
    public boolean shouldSideBeRenderd(IBlockAccess blockAccess, int x, int y, int z, int side) {
        return true;
    }
